...
spectR1 = spectR(myTree, "standard")$eigenvalues
...
test_that("Weighted spectral statistics match perfectly", { # 4 tests
  ...
  expect_equal(mySpecStats[[3]], spectR1)
...
uspectR1 = spectR(uTree, "standard")$eigenvalues
...
test_that("Unweighted spectral statistics match perfectly", { # 5 tests
  ...
  expect_equal(uSpecStats[[3]], uspectR1)
